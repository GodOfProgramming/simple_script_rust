...
impl Stmt {
  ...
  pub fn new_function(name: Token, params: Rc<Vec<Token>>, body: Rc<Vec<Stmt>>, id: usize) -> Self {
...
impl IfStmt {
  pub fn new(condition: Expr, if_true: Vec<Stmt>, if_false: Option<Box<Stmt>>, id: usize) -> Self {
    Self {
      condition,
      if_true,
      if_false,
